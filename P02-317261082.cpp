...
void CreateShaders()
{
	...
	Shader *shader1 = new Shader(); //shader para usar índices: objetos: cubo y  pirámide && se inicializa el shader en 0
...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//Para la pirámide verde oscuro x1
		...
		//Para la pirámide verde oscuro x2
		shaderList[4].useShader();
		uniformModel = shaderList[4].getModelLocation();
		uniformProjection = shaderList[4].getProjectLocation();
		angulo += 0.01;
